...
namespace HuangYi\Swoole\Foundation\Tcp;

use Exception;
use HuangYi\Swoole\Contracts\Tcp\KernelInterface;
use HuangYi\Swoole\Routing\Router;
use HuangYi\Swoole\Tcp\Request;
use HuangYi\Swoole\Routing\Pipeline;
...
class Kernel implements KernelInterface
{
     ...
     *
     * @param  \HuangYi\Swoole\Tcp\Request $request
     * @param  \HuangYi\Swoole\Tcp\Response $response
     * @return void
     */
